...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="media_resource",
            field=models.ManyToManyField(
                related_name="incident_media", to="cloud_resource.incidentmediaresource"
            ),
        ),
        migrations.AddField(
            model_name="incident",
            name="reporter",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="reporters.reporter"
            ),
        ),
        migrations.AddField(
            model_name="incident",
